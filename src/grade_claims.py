...
def grade(args, rotator=None):
    ...
    with open("data/v1_outputs/validation_sample.csv", "w", newline="", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--claims", default="data/claims/claims_raw.csv")
    ap.add_argument("--out", default="data/claims/claims_graded.csv")
