...
def load_publisher_metadata():
    pm = pd.read_csv(Path(__file__).parent / "data/reference/publisher_metadata.csv")
...
def main(args):
    ...
    out.to_csv("data/v1_outputs/model_predictions.csv", index=False)
...
if __name__ == "__main__":
    ...
    ap.add_argument("--claims", default="data/scored/claims_scored.csv")
