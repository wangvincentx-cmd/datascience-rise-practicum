...
def run(episodes, pages_per_term, out_csv, log_csv="data/v1_outputs/search_log.csv"):
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", default="data/claims/claims_raw.csv")
    ap.add_argument("--log-out", default="data/v1_outputs/search_log.csv",
