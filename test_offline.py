...
FULLTEXT_URL = "https://tile.loc.gov/text-services/word-coordinates-service?segment=/foo.xml&format=alto_xml&full_text=1"
RESOURCE_RESP = {
    ...
    "resource": {"fulltext_file": FULLTEXT_URL},
}
FULLTEXT_RESP = {"/foo.xml": {"full_text": "TRUMAN WILL BE ELECTED say local Democrats ..."}}
...
with patch.object(download_loc, "get_json", side_effect=fake_get_json):
    ...
    check("full_text fetched from fulltext_file endpoint", "TRUMAN WILL BE ELECTED" in rec["ocr_text"])
